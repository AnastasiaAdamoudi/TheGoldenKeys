...
const Footer = () => {
  ...
  return (
    <footer className="bottom-0 left-0 right-0 w-full h-auto z-2 text-light flex flex-col items-center justify-center overflow-hidden">
      {/* Gray row */}
      <div className="bg-darkish w-full p-6 h-auto lg:h-[320px] flex flex-col lg:flex-row justify-center items-center">
        {/* Footer Navigation */}
        <div className="flex flex-col items-start mx-6 w-full lg:w-1/3 gap-4">
        ...
        {/* Review button & logos */}
        <div className="flex flex-col w-full lg:w-1/3 mx-6 justify-center items-center my-auto">
        ...
        {/* Opening Times */}
        <div className="flex flex-col w-full lg:w-1/3 justify-center items-center mx-6 my-auto">
